...
\textbf{CS1DM3: Discrete Mathematics for Computer Science \hfill April 9th 2022}\\[0pt]
...
\subpart { \( \lceil \frac{x}{2} \rceil = \lfloor \frac{x+1}{2} \rfloor \).}
...
\textcolor{red}{This required 6.5 knowledge, which is not on the exam.}
